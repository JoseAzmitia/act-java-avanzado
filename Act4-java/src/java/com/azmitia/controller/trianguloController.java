...
import com.azmitia.model.TrianguloEquilatero;

/**
 *
 * @author joK28
 */
@WebServlet(name = "trianguloController", urlPatterns = {"/trianguloController"})
public class trianguloController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            TrianguloEquilatero Triangulo = new TrianguloEquilatero(b,h);
